    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
      ...
      <div className='bg-gray-800 flex flex-col justify-center'>
        <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg' onSubmit={iniciarSesion}>
          ...
          <button className='w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teak-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg' type="submit">Iniciar Sesión</button>
        </form>
      </div>
    </div>
  );
